...
class ExhibitsControllerTest < ActionController::TestCase
  ...
  test "should create exhibit" do
    assert_difference('Exhibit.count') do
      post :create, exhibit: { author: @exhibit.author, date_of_origin: @exhibit.date_of_origin, description: @exhibit.description, place_of_origin: @exhibit.place_of_origin, title: @exhibit.title }
    end
  ...
  test "should update exhibit" do
    patch :update, id: @exhibit, exhibit: { author: @exhibit.author, date_of_origin: @exhibit.date_of_origin, description: @exhibit.description, place_of_origin: @exhibit.place_of_origin, title: @exhibit.title }
    assert_redirected_to exhibit_path(assigns(:exhibit))
  end
